    ...
    s = function s() {
      ...
      if (s) {
        ...
        s.fn[t] = e.jQueryInterface, s.fn[t].Constructor = e, s.fn[t].noConflict = function () {
          return s.fn[t] = _i2, e.jQueryInterface;
        };
      }
      ...
      c && Object.keys(l).forEach(function (s) {
        !function (t, e, s, i) {
          ...
          Object.keys(n).forEach(function (o) {
            if (o.includes(i)) {
              var _i3 = n[o];
              j(t, e, s, _i3.originalHandler, _i3.delegationSelector);
            }
          });
        }(t, l, s, e.slice(1));
      });
  ...
  var Z = /*#__PURE__*/function (_M4) {
    ...
    function Z(t, e) {
      ...
      for (var _t4 = 0, _e8 = s.length; _t4 < _e8; _t4++) {
        var _e9 = s[_t4],
            _i4 = o(_e9),
            _n2 = U.find(_i4).filter(function (t) {
          return t === _this7._element;
        });

        null !== _i4 && _n2.length && (_this7._selector = _i4, _this7._triggerArray.push(_e9));
      }
    ...
    _createClass(Z, [{
      ...
      value: function show() {
        ...
        if (t) {
          ...
          if (e = _i5 ? w.get(_i5, "bs.collapse") : null, e && e._isTransitioning) return;
        }
  ...
  var lt = /*#__PURE__*/function (_M5) {
    ...
    _createClass(lt, [{
        ...
        if (!P.trigger(this._element, "show.bs.dropdown", e).defaultPrevented) {
          ...
          if (this._inNavbar) $.setDataAttribute(this._menu, "popper", "none");else {
            ...
            var _i6 = this._getPopperConfig(),
                _n3 = _i6.modifiers.find(function (t) {
              return "applyStyles" === t.name && !1 === t.enabled;
            });

            this._popper = s.createPopper(_e11, this._menu, _i6), _n3 && $.setDataAttribute(this._menu, "popper", "static");
          }
      ...
      value: function clearMenus(t) {
        ...
        for (var _s6 = 0, _i7 = e.length; _s6 < _i7; _s6++) {
          var _i8 = w.get(e[_s6], "bs.dropdown"),
              _n4 = {
            relatedTarget: e[_s6]
          };

          if (t && "click" === t.type && (_n4.clickEvent = t), !_i8) continue;
          var _o3 = _i8._menu;
          ...
          if (e[_s6].classList.contains("show")) {
            ...
            if (t) {
              if ([_i8._element].some(function (e) {
            ...
            }), e[_s6].setAttribute("aria-expanded", "false"), _i8._popper && _i8._popper.destroy(), _o3.classList.remove("show"), e[_s6].classList.remove("show"), $.removeDataAttribute(_o3, "popper"), P.trigger(e[_s6], "hidden.bs.dropdown", _n4));
          }
        }
      }
    }, {
