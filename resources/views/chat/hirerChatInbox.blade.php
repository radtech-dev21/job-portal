...
<body>
    ...
    <div class="container">
        ...
        <a class="back-icon" href="{{ url('hirer') }}" data-toggle="tooltip" data-placement="top" title="Back"><i class="fas fa-arrow-left"></i></a>
        <div class="messaging">
            <div class="inbox_msg">
                    ...
                    <div class="inbox_chat" style="cursor: pointer;">
                        ...
                        <div class="chat_list">
                            <div class="chat_people">
                                ...
                                <div class="chat_ib">
                                    <h5>{{ $employee['name'] }}<span class="chat_date"></span></h5>
